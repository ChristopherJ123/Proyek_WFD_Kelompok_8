            ...
            return `
                <div id="rule-container-${index}" class="rule-container flex flex-col bg-brand-100 p-2 rounded-2xl">
                    <div class="flex space-x-4 items-center">
                        ...
                        <div class="flex relative justify-between w-full font-semibold">
                            <input class="peer placeholder-transparent focus:outline-brand-500 focus:outline-2" type="text" name="rules[${index}][title]" id="rules[${index}][title]" placeholder="Rule ${index}*">
            ...
            return `
                <div id="moderator-container-${index}" class="moderator-container flex flex-col bg-brand-100 p-2 rounded-2xl">
                    <div class="flex space-x-4 items-center">
                        <span class="text-xl">${index + 1}</span>
                        <div class="flex relative justify-between w-full font-semibold">
                            <input type="text" name="moderators[${index}]" id="moderators[${index}]" placeholder="Username" class="focus:outline-brand-500 focus:outline-2">
                        </div>
                    </div>
                </div>
            `;
