                            ...
                            <li class="flex flex-col gap-2 text-white rounded-4xl bg-brand-300 p-4">
                                <div class="flex flex-col gap-3">
                                    <div class="flex gap-2 mx-8">
                                            <img class="size-8 object-cover rounded-full" src="{{ $post['topic_name'] }}" alt="frieren">
                                    ...
                                    <div class="flex gap-4">
                                        <div class="flex items-center p-2 px-3 gap-3 rounded-4xl bg-brand-900">
                                            ...
                                            <div class="font-sans font-semibold text-xl">{{ $post['upvote_count'] - $post['downvote_count'] }}</div>
                                            <button>
