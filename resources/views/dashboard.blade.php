    ...
    <div class="flex w-full m-4 gap-4 tracking-wider overflow-auto">
        <div class="flex flex-grow-1 flex-col">
            ...
            <ul class="flex flex-col gap-8">
                @if(Auth::check())
                    @if(isset($user_topic_followings))
                        @foreach($user_topic_followings as $topic_following)
                ...
                <li class="flex flex-col gap-2 text-white rounded-4xl bg-brand-300 p-4">
                    <div class="flex flex-col gap-3">
                        ...
                        <img class="max-h-96 mx-8 object-cover rounded-2xl"
                             src="https://cdn.apartmenttherapy.info/image/upload/v1565275640/k/Photo/Lifestyle/2019-08-cleaning-every-pot-and-pan/Dirty-Pans_091.jpg"
                             alt="wok">
                ...
                <li class="flex flex-col gap-2 text-white rounded-4xl bg-brand-300 p-4">
                    <div class="flex flex-col gap-3">
                        ...
                        <img class="max-h-96 mx-8 object-cover rounded-2xl"
                             src="https://www.greenscene.co.id/wp-content/uploads/2024/10/ultraman-big.jpg" alt="wok">
                        <div class="flex gap-4">
                            <div class="flex items-center p-2 px-3 gap-3 rounded-4xl bg-brand-900">
                                <button>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="size-6"
...
{{--                                    <div class="font-bold text-2xl">y/{{ $topic_following['name'] }}</div>--}}
{{--                                </div>--}}
...
{{--                            </li>--}}
                ...
                <li class="py-4 first:pt-0 last:pb-0 break-words">
                    <div class="flex gap-2">
                        <img class="size-8 object-cover rounded-full" src="images_temp/programming-raw.jpg"
                             alt="frieren">
                ...
                <li class="py-4 first:pt-0 last:pb-0 break-words">
                    ...
                    <div class="tracking-normal font-sans tracking-tighter font-medium line-clamp-2">
                        STOP THE VOICES INSIDE MY HEAD STOP THE VOICES INSIDE MY HEAD STOP THE VOICES INSIDE MY HEAD
                        STOP THE VOICES INSIDE MY HEAD STOP THE VOICES INSIDE MY HEAD
                    </div>
                    <div class="text-gray-900">343 upvote 82 comments</div>
                </li>
                <li class="py-4 first:pt-0 last:pb-0 break-words">
